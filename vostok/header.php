...
<div id="wrapper">
	<div id="header">
		<a href="<?php echo get_option('home'); ?>/"><img height="200" width="600" src="http://minicinema.tv/wordpress/wp-content/uploads/2012/08/blog_header_image.jpg" title="<?php bloginfo('name'); ?>" alt="<?php bloginfo('description'); ?>"/></a>
